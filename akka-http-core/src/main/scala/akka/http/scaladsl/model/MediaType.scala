...
object MediaTypes extends ObjectRegistry[(String, String), MediaType] {
  ...
  val `application/mspowerpoint`                                                  = abin("mspowerpoint", NotCompressible, "pot", "pps", "ppz")
  val `application/vnd.ms-powerpoint`                                             = abin("vnd.ms-powerpoint", NotCompressible, "ppt")
