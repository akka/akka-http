...
import akka.http.scaladsl.settings.ParserSettings.{ ConflictingResponseContentTypeHeaderProcessingMode, CookieParsingMode, ErrorLoggingVerbosity, IllegalResponseHeaderValueProcessingMode, IllegalResponseHeaderNameProcessingMode }
...
private[akka] final case class ParserSettingsImpl(
  ...
  conflictingResponseContentTypeHeaderProcessingMode: ConflictingResponseContentTypeHeaderProcessingMode,
...
object ParserSettingsImpl extends SettingsCompanionImpl[ParserSettingsImpl]("akka.http.parsing") {
  ...
  def fromSubConfig(root: Config, inner: Config): ParserSettingsImpl = {
    ...
    new ParserSettingsImpl(
      ...
      ConflictingResponseContentTypeHeaderProcessingMode(c.getString("conflicting-response-content-type-header-processing-mode")),
