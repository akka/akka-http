 ...
 * akka.http.javadsl.model.headers.RawHeader}. Not for user extension.
 */
@DoNotInherit
public abstract class HttpHeader {
  ...
  public static HttpHeader parse(String name, String value) {
    final akka.http.scaladsl.model.HttpHeader.ParsingResult result =
        akka.http.scaladsl.model.HttpHeader.parse(
            name, value, akka.http.impl.model.parser.HeaderParser$.MODULE$.DefaultSettings());
    ...
    if (result instanceof akka.http.scaladsl.model.HttpHeader$ParsingResult$Ok) {
      ...
      throw new IllegalHeaderException(
          ((akka.http.scaladsl.model.HttpHeader$ParsingResult$Error) result).error());
    }
  }
}
