...
public abstract class AccessControlAllowMethods extends akka.http.scaladsl.model.HttpHeader {
  ...
  public static AccessControlAllowMethods create(HttpMethod... methods) {
    return new akka.http.scaladsl.model.headers.Access$minusControl$minusAllow$minusMethods(
        akka.http.impl.util.Util.<HttpMethod, akka.http.scaladsl.model.HttpMethod>convertArray(
            methods));
  }
}
