...
public abstract class ContentDisposition extends akka.http.scaladsl.model.HttpHeader {
  ...
  public static ContentDisposition create(
    ...
    return new akka.http.scaladsl.model.headers.Content$minusDisposition(
        ((akka.http.scaladsl.model.headers.ContentDispositionType) dispositionType),
        akka.http.impl.util.Util.convertMapToScala(params));
  }
}
