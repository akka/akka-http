...
public final class HttpMethods {
   ...
   */
  @Deprecated
  public static HttpMethod createCustom(
      String value,
      boolean safe,
      boolean idempotent,
      akka.http.javadsl.model.RequestEntityAcceptance requestEntityAcceptance) {
  ...
  public static HttpMethod custom(
    ...
    return akka.http.scaladsl.model.HttpMethod.custom(
  ...
  public static Optional<HttpMethod> lookup(String name) {
    return Util.<HttpMethod, akka.http.scaladsl.model.HttpMethod>lookupInRegistry(
