...
public final class Multiparts {
  ...
  public static Multipart.FormData createFormDataFromParts(Multipart.FormData.BodyPart... parts) {
    return akka.http.scaladsl.model.Multipart.FormData$.MODULE$.createNonStrict(
        convertArray(parts));
  }
  /**
   * Constructor for `multipart/form-data` content as defined in http://tools.ietf.org/html/rfc2388.
  ...
  public static Multipart.FormData createFormDataFromPath(
    ...
    return akka.http.scaladsl.model.Multipart.FormData$.MODULE$.fromPath(
        name, (akka.http.scaladsl.model.ContentType) contentType, path, chunkSize);
  }
  ...
  public static Multipart.FormData createFormDataFromPath(
    ...
    return akka.http.scaladsl.model.Multipart.FormData$.MODULE$.fromPath(
        name, (akka.http.scaladsl.model.ContentType) contentType, path, -1);
  }
  ...
  public static Multipart.FormData.BodyPart createFormDataPartFromPath(
      String name, ContentType contentType, Path path, int chunkSize) {
    return akka.http.scaladsl.model.Multipart$FormData$BodyPart$.MODULE$.fromPath(
        name, (akka.http.scaladsl.model.ContentType) contentType, path, chunkSize);
  }
  ...
  public static Multipart.FormData.BodyPart createFormDataBodyPart(
    ...
    return akka.http.scaladsl.model.Multipart$FormData$BodyPart$Builder$.MODULE$.create(
        name,
        (akka.http.scaladsl.model.BodyPartEntity) entity,
  ...
  public static Multipart.FormData.BodyPart.Strict createFormDataBodyPartStrict(
    ...
    List nil = Nil$.MODULE$;
    Map<String, String> additionalDispositionParams = Collections.emptyMap();
    return akka.http.scaladsl.model.Multipart$FormData$BodyPart$StrictBuilder$.MODULE$.createStrict(
        name,
        (akka.http.scaladsl.model.HttpEntity.Strict) entity,
        convertMapToScala(additionalDispositionParams),
        nil);
  }
