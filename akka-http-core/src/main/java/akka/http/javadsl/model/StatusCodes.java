...
public final class StatusCodes {
  ...
  public static final StatusCode SWITCHING_PROTOCOLS =
      akka.http.scaladsl.model.StatusCodes.SwitchingProtocols();
  ...
  public static final StatusCode NON_AUTHORITATIVE_INFORMATION =
      akka.http.scaladsl.model.StatusCodes.NonAuthoritativeInformation();
  ...
  public static final StatusCode RESET_CONTENT =
      akka.http.scaladsl.model.StatusCodes.ResetContent();
  public static final StatusCode PARTIAL_CONTENT =
      akka.http.scaladsl.model.StatusCodes.PartialContent();
  ...
  public static final StatusCode ALREADY_REPORTED =
      akka.http.scaladsl.model.StatusCodes.AlreadyReported();
  ...
  public static final StatusCode MULTIPLE_CHOICES =
      akka.http.scaladsl.model.StatusCodes.MultipleChoices();
  public static final StatusCode MOVED_PERMANENTLY =
      akka.http.scaladsl.model.StatusCodes.MovedPermanently();
  ...
  public static final StatusCode TEMPORARY_REDIRECT =
      akka.http.scaladsl.model.StatusCodes.TemporaryRedirect();
  public static final StatusCode PERMANENT_REDIRECT =
      akka.http.scaladsl.model.StatusCodes.PermanentRedirect();
  ...
  public static final StatusCode PAYMENT_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.PaymentRequired();
  ...
  public static final StatusCode NOT_ACCEPTABLE =
      akka.http.scaladsl.model.StatusCodes.NotAcceptable();
  public static final StatusCode PROXY_AUTHENTICATION_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.ProxyAuthenticationRequired();
  public static final StatusCode REQUEST_TIMEOUT =
      akka.http.scaladsl.model.StatusCodes.RequestTimeout();
  ...
  public static final StatusCode LENGTH_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.LengthRequired();
  public static final StatusCode PRECONDITION_FAILED =
      akka.http.scaladsl.model.StatusCodes.PreconditionFailed();
  public static final StatusCode PAYLOAD_TOO_LARGE =
      akka.http.scaladsl.model.StatusCodes.PayloadTooLarge();

  /** @deprecated deprecated in favor of PAYLOAD_TOO_LARGE */
  @Deprecated
  public static final StatusCode REQUEST_ENTITY_TOO_LARGE =
      akka.http.scaladsl.model.StatusCodes.RequestEntityTooLarge();
  ...
  public static final StatusCode REQUEST_URI_TOO_LONG =
      akka.http.scaladsl.model.StatusCodes.RequestUriTooLong();

  public static final StatusCode UNSUPPORTED_MEDIA_TYPE =
      akka.http.scaladsl.model.StatusCodes.UnsupportedMediaType();
  public static final StatusCode RANGE_NOT_SATISFIABLE =
      akka.http.scaladsl.model.StatusCodes.RangeNotSatisfiable();

  /** @deprecated deprecated in favor of RANGE_NOT_SATISFIABLE */
  @Deprecated
  public static final StatusCode REQUESTED_RANGE_NOT_SATISFIABLE =
      akka.http.scaladsl.model.StatusCodes.RequestedRangeNotSatisfiable();

  public static final StatusCode EXPECTATION_FAILED =
      akka.http.scaladsl.model.StatusCodes.ExpectationFailed();
  ...
  public static final StatusCode ENHANCE_YOUR_CALM =
      akka.http.scaladsl.model.StatusCodes.EnhanceYourCalm();
  public static final StatusCode MISDIRECTED_REQUEST =
      akka.http.scaladsl.model.StatusCodes.MisdirectedRequest();
  public static final StatusCode UNPROCESSABLE_ENTITY =
      akka.http.scaladsl.model.StatusCodes.UnprocessableEntity();
  ...
  public static final StatusCode FAILED_DEPENDENCY =
      akka.http.scaladsl.model.StatusCodes.FailedDependency();
  ...
  public static final StatusCode UNORDERED_COLLECTION =
      akka.http.scaladsl.model.StatusCodes.UnorderedCollection();
  ...
  public static final StatusCode UPGRADE_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.UpgradeRequired();
  public static final StatusCode PRECONDITION_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.PreconditionRequired();
  public static final StatusCode TOO_MANY_REQUESTS =
      akka.http.scaladsl.model.StatusCodes.TooManyRequests();
  public static final StatusCode REQUEST_HEADER_FIELDS_TOO_LARGE =
      akka.http.scaladsl.model.StatusCodes.RequestHeaderFieldsTooLarge();
  ...
  public static final StatusCode BLOCKED_BY_PARENTAL_CONTROLS =
      akka.http.scaladsl.model.StatusCodes.BlockedByParentalControls();
  public static final StatusCode UNAVAILABLE_FOR_LEGAL_REASONS =
      akka.http.scaladsl.model.StatusCodes.UnavailableForLegalReasons();
  ...
  public static final StatusCode GATEWAY_TIMEOUT =
      akka.http.scaladsl.model.StatusCodes.GatewayTimeout();
  public static final StatusCode HTTPVERSION_NOT_SUPPORTED =
      akka.http.scaladsl.model.StatusCodes.HttpVersionNotSupported();
  public static final StatusCode VARIANT_ALSO_NEGOTIATES =
      akka.http.scaladsl.model.StatusCodes.VariantAlsoNegotiates();
  public static final StatusCode INSUFFICIENT_STORAGE =
      akka.http.scaladsl.model.StatusCodes.InsufficientStorage();
  public static final StatusCode LOOP_DETECTED =
      akka.http.scaladsl.model.StatusCodes.LoopDetected();
  public static final StatusCode BANDWIDTH_LIMIT_EXCEEDED =
      akka.http.scaladsl.model.StatusCodes.BandwidthLimitExceeded();
  ...
  public static final StatusCode NETWORK_AUTHENTICATION_REQUIRED =
      akka.http.scaladsl.model.StatusCodes.NetworkAuthenticationRequired();
  public static final StatusCode NETWORK_READ_TIMEOUT =
      akka.http.scaladsl.model.StatusCodes.NetworkReadTimeout();
  public static final StatusCode NETWORK_CONNECT_TIMEOUT =
      akka.http.scaladsl.model.StatusCodes.NetworkConnectTimeout();
  ...
  public static StatusCode custom(
    ...
    return akka.http.scaladsl.model.StatusCodes.custom(
  ...
  public static Optional<StatusCode> lookup(int intValue) {
    return Util.<StatusCode, akka.http.scaladsl.model.StatusCode>lookupInRegistry(
