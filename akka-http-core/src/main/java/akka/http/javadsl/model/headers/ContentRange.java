...
public abstract class ContentRange extends akka.http.scaladsl.model.HttpHeader {
  ...
  public static ContentRange create(
      RangeUnit rangeUnit, akka.http.javadsl.model.ContentRange contentRange) {
    return new akka.http.scaladsl.model.headers.Content$minusRange(
        ((akka.http.scaladsl.model.headers.RangeUnit) rangeUnit),
        ((akka.http.scaladsl.model.ContentRange) contentRange));
  }
}
