...
public abstract class AcceptEncoding extends akka.http.scaladsl.model.HttpHeader {
  ...
  public static AcceptEncoding create(HttpEncoding encoding) {
    return new akka.http.scaladsl.model.headers.Accept$minusEncoding(
        Util.<HttpEncodingRange, akka.http.scaladsl.model.headers.HttpEncodingRange>convertArray(
            new HttpEncodingRange[] {encoding.toRange()}));
  }
