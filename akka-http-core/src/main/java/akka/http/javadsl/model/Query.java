...
public abstract class Query {
  ...
  public static Query create(
      String rawQuery, akka.http.scaladsl.model.Uri.ParsingMode parsingMode) {
   ...
   */
  public static Query create(
      String rawQuery, Charset charset, akka.http.scaladsl.model.Uri.ParsingMode parsingMode) {
    return new JavaQuery(
        akka.http.scaladsl.model.Uri.Query$.MODULE$.apply(
