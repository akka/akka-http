...
public final class LinkParams {
  ...
  public static LinkParam hreflang(Language language) {
    return new akka.http.scaladsl.model.headers.LinkParams.hreflang(
        (akka.http.scaladsl.model.headers.Language) language);
  }
  ...
  public static LinkParam type(MediaType type) {
    return new akka.http.scaladsl.model.headers.LinkParams.type(
        (akka.http.scaladsl.model.MediaType) type);
  }
}
