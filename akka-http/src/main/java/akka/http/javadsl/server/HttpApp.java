...
/**
 * API MAY CHANGE - EXPERIMENTAL Bootstrap trait for Http Server. It helps booting up an akka-http
 * server by only defining the desired routes. It offers additional hooks to modify the default
 * behavior.
 */
@ApiMayChange
public abstract class HttpApp extends AllDirectives {
  ...
  public void startServer(
    ...
    CompletionStage<ServerBinding> bindingFuture =
        Http.get(theSystem)
            .bindAndHandle(
                routes().flow(theSystem, materializer),
