...
## akka-http-quickstart-java zip file
prepareTemporalFolder
fetchProject ${samples_sources}/akka-http-quickstart-java akka-http-quickstart
zipAndAttach ${docs_attachments}/akka-http-quickstart-java.zip ${target_temporal_attachments}

## akka-http-quickstart-scala zip file
prepareTemporalFolder
fetchProject ${samples_sources}/akka-http-quickstart-scala akka-http-quickstart
zipAndAttach ${docs_attachments}/akka-http-quickstart-scala.zip ${target_temporal_attachments}
