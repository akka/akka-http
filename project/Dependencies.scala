...
object Dependencies {
  ...
  val jacksonDatabindVersion = "2.18.8"
  ...
  object Compile {
    val scalaXml      =  "org.scala-lang.modules" %% "scala-xml" % "2.4.0" // Scala License



    // For akka-http spray-json support
    val sprayJson   = "io.spray"                     %% "spray-json"                   % "1.3.6"       // ApacheV2
    val jwtScala    = "com.github.jwt-scala"         %% "jwt-json-common"              % "11.0.4"      // ApacheV2
