...
A good read on the subject of how to deal with trailing slashes is available on [Google Search Central - To Slash or not to Slash](https://developers.google.com/search/blog/2010/04/to-slash-or-not-to-slash).
