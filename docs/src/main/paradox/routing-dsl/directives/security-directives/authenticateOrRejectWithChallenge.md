...
More details about challenge-response authentication are available in the [RFC 2617](https://datatracker.ietf.org/doc/html/rfc2617), [RFC 7616](https://datatracker.ietf.org/doc/html/rfc7616) and [RFC 7617](https://datatracker.ietf.org/doc/html/rfc7617).
