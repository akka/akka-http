...
* Allow multiple Host headers in responses [#3158](https://github.com/akka/akka-http/pull/3158)
...
* use new ActorSystem API [#3242](https://github.com/akka/akka-http/pull/3242)
...
* build: build with Scala 2.13 by default [#3126](https://github.com/akka/akka-http/pull/3126)
