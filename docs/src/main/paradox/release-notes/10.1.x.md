...
10.1.8 is the ninth release in the 10.1.x series of Akka HTTP. See the [announcement](https://akka.io/blog/news/2019/03/20/akka-http-10.1.8-released.html) and the full list of changes below.
