 ...
 * Adds missing parameter with required value directive for Java API ([#2025](https://github.com/akka/akka-http/issues/2025)) ([#2026](https://github.com/akka/akka-http/issues/2026))
 ...
 * Add missing methods for creating custom binary MediaTypes ([#2008](https://github.com/akka/akka-http/issues/2008)) ([#2012](https://github.com/akka/akka-http/issues/2012))
