...
@@snip [QuickstartApp.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/QuickstartApp.scala) { #main-class }
...
@@snip [UserRoutes.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/UserRoutes.scala) { #users-get-post }
...
@@snip [QuickstartServer.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/UserRoutes.scala) { #users-get-delete }
...
@@snip [UserRoutes.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/UserRoutes.scala) { #retrieve-user-info }
...
@@snip [UserRoutes.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/UserRoutes.scala) { #users-delete-logic }
...
@@snip [UserRoutes.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/UserRoutes.scala) { #all-routes }
...
@@snip [QuickstartApp.scala](/samples/akka-http-quickstart-scala/src/main/scala/com/example/QuickstartApp.scala) { #start-http-server }
