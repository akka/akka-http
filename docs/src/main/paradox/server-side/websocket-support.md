...
Scala
:  @@snip [Message.scala]($akka-http$/akka-http-model/src/main/scala/akka/http/scaladsl/model/ws/Message.scala) { #message-model }

Java
:  @@snip [Message.scala]($akka-http$/akka-http-model/src/main/scala/akka/http/javadsl/model/ws/Message.scala) { #message-model }
