...
@scala[@scaladoc[@unidoc[akka.http.scaladsl.model.ws.Message]](akka.http.scaladsl.model.ws.Message)]@java[@javadoc[@unidoc[akka.http.scaladsl.model.ws.Message]](akka.http.javadsl.model.ws.Message)].
@scala[The subclasses @unidoc[BinaryMessage] and @unidoc[TextMessage] contain methods to access the data.]
@java[The superclass @javadoc[@unidoc[akka.http.scaladsl.model.ws.Message]](akka.http.javadsl.model.ws.Message)]
