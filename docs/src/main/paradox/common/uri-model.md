...
We follow [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986#section-1.1.2) to implement the URI parsing rules.
...
For exact definitions of the parts of a URI, like `scheme`, `path` and `query` refer to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986#section-1.1.2).
...
As in the [section 3.4 of RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986#section-3.4),
