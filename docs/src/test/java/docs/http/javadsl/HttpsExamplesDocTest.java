...
public class HttpsExamplesDocTest {
  ...
  public void testConstructRequest() {
    ...
    // WARNING: disabling SNI is a very bad idea, please don't unless you have a very good reason
    // to.
    final AkkaSSLConfig defaultSSLConfig = AkkaSSLConfig.get(system);
    final AkkaSSLConfig badSslConfig =
        defaultSSLConfig.convertSettings(s -> s.withLoose(s.loose().withDisableSNI(true)));
