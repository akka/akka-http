...
public class ClientSingleRequestExample {
  ...
  public static void main(String[] args) {
    ...
    final CompletionStage<HttpResponse> responseFuture =
        Http.get(system).singleRequest(HttpRequest.create("https://akka.io"));
  }
}
// #single-request-example
...
class OtherRequestResponseExamples {
  ...
  public void response() {
    ...
    CompletionStage<Pet> pet =
        Jackson.unmarshaller(Pet.class).unmarshal(response.entity(), materializer);
    // #unmarshal-response-body
  }
}
